...
public class MainActivity extends Activity {
    private static final int VERSION_NUMBER = 52;
...
//                FragmentManager fragmentManager = getSupportFragmentManager();
    ...
    private void showWhatNew() {
        ...
        String title2_2_5 = "Version 2.2.5(Beta)";
        String text2_2_5 = " - Direct dial/SMS" +
                "\n - Folder support" +
                "\n - Indicator";
        ...
        SpannableString span2_2_5 = new SpannableString(title2_2_5);
        span2_2_5.setSpan(new AbsoluteSizeSpan(titleSize),0,title2_2_5.length(), Spanned.SPAN_INCLUSIVE_INCLUSIVE);
