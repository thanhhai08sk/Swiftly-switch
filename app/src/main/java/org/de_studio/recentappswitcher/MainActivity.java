...
public class MainActivity extends Activity {
    private static final int VERSION_NUMBER = 55;
...
//                FragmentManager fragmentManager = getSupportFragmentManager();
    ...
    private void showWhatNew() {
        ...
        String title2_2_7 = "Version 2.2.7";
        String text2_2_7 = " - Support contact shortcut" +
                "\n - Support folder" +
                "\n - Indicator" +
                "\n - Change the default setting for Quick Action";
        String title2_2_4 = "Version 2.2.4";
        String text2_2_4 = " - Bug fixed";
        ...
        SpannableString span2_2_5 = new SpannableString(title2_2_7);
        span2_2_5.setSpan(new AbsoluteSizeSpan(titleSize),0,title2_2_7.length(), Spanned.SPAN_INCLUSIVE_INCLUSIVE);
        SpannableString span2_2_4 = new SpannableString(title2_2_4);
        span2_2_4.setSpan(new AbsoluteSizeSpan(titleSize),0,title2_2_4.length(), Spanned.SPAN_INCLUSIVE_INCLUSIVE);
        ...
        CharSequence finalText = TextUtils.concat(span2_2_5,"\n\n",text2_2_7,"\n\n", span2_2_4,"\n\n", text2_2_4, "\n\n", span2_2_3 , "\n\n" , text2_2_3 , "\n\n" , span2_2_2 , "\n\n" , text2_2_2
                , "\n\n" , span2_2_1 , "\n\n" , text2_2_1);
